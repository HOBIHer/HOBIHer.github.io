...
function TinderIcon(props) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M8.4,9.464c4.05-1.286,4.693-5.014,4.179-8.357c0,0,0-0.193,0.129-0.129C16.629,2.907,21,6.957,21,13.193 C21,17.821,17.336,22,12,22c-5.786,0-9-4.05-9-8.871c0-2.893,1.929-5.786,4.179-7.071c0,0,0.193,0,0.193,0.129 c0,0.643,0.257,2.25,0.964,3.214L8.4,9.464z"
      />
    </svg>
  )
}
...
export const socialMediaProfiles = [
  ...
  { title: 'Wechat', href: 'https://wechat.com', icon: WechatIcon },
  { title: 'Instagram', href: 'https://www.instagram.com/ha1dangbu/', icon: InstagramIcon },
  { title: 'GitHub', href: 'https://github.com/HOBIHer', icon: GitHubIcon },
  { title: 'LinkedIn', href: 'https://www.linkedin.com/in/jiaqi-liu-5b1622230/', icon: LinkedInIcon },
  { title: 'Tinder', href: 'https://tinder.com', icon: TinderIcon },
